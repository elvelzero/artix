...
echo "=====:=====:===== Download package that i need part 1 =====:=====:====="
...
echo "=====:=====:===== Download package that i need part 2 =====:=====:====="
...
echo "=====:=====:===== Install Visual Studio Code, Intellij IDEA, Android Studio =====:=====:====="
